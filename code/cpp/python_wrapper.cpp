...
PYBIND11_MODULE(pysnax, m)
{
  ...
  m.def("sigma0", &sigma0, "Primakoff cross section for massless ALPs (in eV^-2).", "g"_a, "ea"_a, "ks2"_a=ks2_jaeckel17);
  m.def("sigma", &sigma, "Primakoff cross section for massive ALPs (in eV^-2).", "m"_a, "g"_a, "ea"_a, "ks2"_a=ks2_jaeckel17);
